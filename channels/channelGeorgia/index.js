...
const CHANNEL_ID = "@CheapFlightsGeorgia";
const airports = ["TBS", "KUT", "BUS"];
const locale = "ka"; // for getCityName and depDate = dtDeparture.setLocale("ro")
const rateFlight = (f) => {
  const price = f.price;
...
const REDIS_KEY = "Georgia:last_titles";
const language = "ka";
const shareText = "გაუზიარე მეგობრებს";
const linkText = "იაფი ფრენების ბოტი";
const preMessage = {
  flightItem({
    originName,
    destinationName,
...
🔗 ბმული: <a href="${link}"><b>https://${short}</b></a>\n`;
  },
