...
const CHANNEL_ID = "@CheapFlightsKazakhstan";
const airports = [
  "ALA", // Almaty – главный авиа-хаб страны
  "NQZ", // Astana – столица (ex TSE)
  "CIT", // Shymkent – юг, высокий трафик
  "AKX", // Aktobe – запад
  "GUW", // Atyrau – нефтяной регион
  "UKK", // Ust-Kamenogorsk
  "PWQ", // Pavlodar
  "KZO", // Kyzylorda
  "SCO", // Aktau – Каспий, Турция
  "DMB", // Taraz
];
const locale = "kk"; // for getCityName and depDate = dtDeparture.setLocale("ro")
const rateFlight = (f) => {
  const price = f.price;
...
const REDIS_KEY = "Kazakhstan:last_titles";
const language = "kk";
const shareText = "Достарыңмен бөліс!";
const linkText = "Арзан әуе билеттері боты";
const preMessage = {
  flightItem({
    originName,
    destinationName,
...
🔗 Сілтеме: <a href="${link}"><b>https://${short}</b></a>\n`;
  },
