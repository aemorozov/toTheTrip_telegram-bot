...
const locale = "de"; // for getCityName and depDate = dtDeparture.setLocale("ro")
const rateFlight = (f) => {
  const price = f.price;
...
const REDIS_KEY = "Germany:last_titles";
const language = "de";
const shareText = "Teile es mit Freunden";
const linkText = "Dein Bot für günstige Flüge";
const preMessage = {
  flightItem({
    originName,
    destinationName,
