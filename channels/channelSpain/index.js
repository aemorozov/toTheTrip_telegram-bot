...
const locale = "es"; // for getCityName and depDate = dtDeparture.setLocale("ro")
const rateFlight = (f) => {
  const price = f.price;
...
const language = "es";
const shareText = "¡Compártelo con tus amigos";
const linkText = "Tu bot de vuelos baratos";
const preMessage = {
  flightItem({
    originName,
    destinationName,
...
🔗 Enlace: <a href="${link}"><b>https://${short}</b></a>\n`;
  },
