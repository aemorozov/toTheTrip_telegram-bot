...
const CHANNEL_ID = "@CheapFlightsArmenia";
const airports = ["EVN", "GYU"];
const locale = "hy"; // for getCityName and depDate = dtDeparture.setLocale("ro")
const rateFlight = (f) => {
  const price = f.price;
...
const REDIS_KEY = "Armenia:last_titles";
const language = "hy";
const shareText = "Կիսվիր ընկերներիդ հետ";
const linkText = "Էժան թռիչքների բոտ";
const preMessage = {
  flightItem({
    originName,
    destinationName,
...
🔗 Հղում: <a href="${link}"><b>https://${short}</b></a>\n`;
  },
